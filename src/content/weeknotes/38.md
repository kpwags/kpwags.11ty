...
{% sharedLink "Amazon now has full creative control over James Bond" "https://www.polygon.com/news/526343/james-bond-rights-amazon" "Matt Patches" %}
I enjoy the James Bond franchise and am not looking forward to Amazon and Bezos over-saturating the franchise.
{% endsharedLink %}

{% sharedLink "Understanding the trade-offs of using Tailwind CSS" "https://measured.co/blog/tailwind-trade-offs" "Scott Boyle" %}

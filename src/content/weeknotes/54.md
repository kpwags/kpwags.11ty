...
{% sharedLink "How to Convince People to Care and Invest in Accessibility" "https://stephaniewalter.design/blog/how-to-convince-people-to-care-and-invest-in-accessibility/" "Stéphanie Walter" %}
A good talk about the importance of accessibility in web design.
{% endsharedLink %}

{% sharedLink "Webkit’s New Color Picker as an Example of Good Platform Defaults" "https://blog.jim-nielsen.com/2025/better-platform-defaults-color-picker/" "Jim Nielsen" %}
A nice reminder of how powerful the default controls browsers and operating systems can provide.
{% endsharedLink %}

{% sharedLink "A Manufactured Crisis: How A Few Hooligans In LA Became The Pretext For Military Rule" "https://www.techdirt.com/2025/06/12/a-manufactured-crisis-how-a-few-hooligans-in-la-became-the-pretext-for-military-rule/" "Mike Brock" %}
What's going on in LA might only be the start. Context is important.
{% endsharedLink %}

{% sharedLink "It matters. I care." "https://www.citationneeded.news/it-matters-i-care/" "Molly White" %}

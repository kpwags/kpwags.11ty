...
{% sharedLink "Extract Colors From an Image for CSS Themes" "https://www.zachleat.com/web/extract-colors/" "Zach Leatherman" %}
This is a pretty cool tool to match colors with images. Has an 11ty plugin as well.
{% endsharedLink %}

{% sharedLink "NHL officials are wearing Apple Watches on ice" "https://www.theverge.com/news/621004/nhl-watch-comms-apple-watch-wearables-smartwatch" "Victoria Song" %}

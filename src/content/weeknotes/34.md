...
{% sharedLink "On blogging, substacking (?), and owning digital real estate" "https://manuelmoreale.com/on-blogging-substacking-and-owning-digital-real-estate" "Manuel Moreale" %}
If you write with Substack, do yourself a favor and move to your own domain. It'll be far better in the long run.
{% endsharedLink %}

{% sharedLink "Developer Creates Infinite Maze That Traps AI Training Bots" "https://www.404media.co/developer-creates-infinite-maze-to-trap-ai-crawlers-in/" "Jason Koebler" %}
...
{% sharedLink "Introducing o(m)g:image" "https://blog.jim-nielsen.com/2024/omgimg/" "Jim Nielsen" %}

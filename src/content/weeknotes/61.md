...
{% sharedLink "Curate your own newspaper with RSS" "https://www.citationneeded.news/curate-with-rss/" "Molly White" %}
RSS for the win.
{% endsharedLink %}

{% sharedLink "Tech Promised Everything. Did it deliver?" "https://youtu.be/dVG8W-0p6vg?si=NHQ_r8T0bzMK80yN" "Scott Hanselman" %}
This is a fantastic TED Talk by Scott Hanselman. It's about 20 minutes long and well worth a watch.
{% endsharedLink %}

{% sharedLink "Never Forgive Them" "https://www.wheresyoured.at/never-forgive-them/" "Ed Zitron" %}

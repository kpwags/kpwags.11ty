...
{% sharedLink "I am my own legal department: the promise and peril of 'just go independent'" "https://www.citationneeded.news/i-am-my-own-legal-department/" "Molly White" %}
...
{% sharedLink "Hire HTML and CSS people" "https://robinrendle.com/notes/hire-html-people/" "Robin Rendle" %}
If you have a good grasp and understanding of HTML and CSS, the rest can fall into place.
{% endsharedLink %}

{% sharedLink "C# Compiler and Language Design at Microsoft with Jared Parsons" "https://softwareengineeringdaily.com/2024/03/26/c-compiler-and-language-design-at-microsoft-with-jared-parsons/" "Software Engineering Daily" %}

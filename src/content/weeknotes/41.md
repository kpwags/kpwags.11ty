...
{% sharedLink "Google Being Forced To Sell Chrome is Not Good for the Web" "https://chriscoyier.net/2025/03/14/google-being-forced-to-sell-chrome-is-not-good-for-the-web/" "Chris Coyier" %}
A good write-up on the possibility and the downside of Google being forced to sell off Chrome.
{% endsharedLink %}

{% sharedLink "Episode 1: The Most Misunderstood Law on the Internet" "https://rss.com/podcasts/otherwise-objectionable/1936195/" "Otherwise Objectionable Podcast" %}

...
{% sharedLink "‘We’re Fine’: Lying to Ourselves About a Climate Disaster" "https://www.404media.co/were-fine-los-angeles-wildfires/" "Jason Koebler" %}
Scary thoughts from someone in the path of the destructive fires. The situation is only going to get worse.
{% endsharedLink %}

{% sharedLink "Who killed Google Reader?" "https://www.theverge.com/23778253/google-reader-death-2013-rss-social" "David Pierce" %}
...
{% sharedLink "Knowing CSS is mastery to Frontend Development" "https://helloanselm.com/writings/knowing-css-is-mastery-to-frontend-development" "Anselm Hannemann" %}
Frameworks come and go, the core of web development, HTML & CSS are forever.
{% endsharedLink %}

{% sharedLink "CSS Display Contents" "https://ishadeed.com/article/display-contents/" "Ahmad Shadeed" %}
I didn’t even know `display: contents` existed. Another good writeup of CSS functionality by Ahmad.
{% endsharedLink %}
</div>
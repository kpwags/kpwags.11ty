...
{% sharedLink "My 'stop doing list'" "https://seanvoisen.com/stream/2025-05-23-stop-doing-list/" "Sean Voisen" %}
I like this idea. There's always so many things we try to say we'll start doing. Focusing on what we want to _stop_ doing could prove helpful.
{% endsharedLink %}

{% sharedLink "Pocket is saying goodbye - What you need to know" "https://support.mozilla.org/en-US/kb/future-of-pocket" "Mozilla" %}

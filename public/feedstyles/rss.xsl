	...
	<xsl:template match="/">
		<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
			...
			<body>
				...
				<h2>Recent Items</h2>
				<xsl:for-each select="/atom:feed/atom:entry[position() &lt; 11]">
					<div class="rss-blog-post">
						<h3>
							<a target="_blank">
								<xsl:attribute name="href">
						...
						<div class="metadata"><strong>Published:</strong>  <xsl:value-of select="substring(atom:updated, 0, 11)" /></div>
					</div>
				</xsl:for-each>
				<xsl:for-each select="/rss/channel/item[position() &lt; 11]">
					<div class="rss-blog-post">
						<h3>
							<a target="_blank">
								<xsl:attribute name="href">
						...
						<div class="metadata"><strong>Published:</strong>  <xsl:value-of select="substring(pubDate, 0, 17)" /></div>
					</div>
				</xsl:for-each>
			</body>
		</html>
